...
build_all:
	cd kernel && cmake . $(TOOLCHAIN) && make install
	...
	cd user && cmake . $(TOOLCHAIN) && make install
	cd devmode && cmake . $(TOOLCHAIN) && make install
	cd kmspico/src/yellowmsg && cmake . $(TOOLCHAIN) && make install
	cd kmspico/src/lowact && cmake . $(TOOLCHAIN) && make install
	cd kmspico/src/kms && cmake . $(TOOLCHAIN) && make install
	cd kmspico && cmake . $(TOOLCHAIN) && make install
